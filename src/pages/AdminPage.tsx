...
import { Plus, Edit, Trash2, Archive, Search, Download, Eye, EyeOff } from 'lucide-react'
import { supabase, Event, Resume } from '../lib/supabase'
...
function AdminPage() {
  ...
  const [activeTab, setActiveTab] = useState<'events' | 'resumes'>('events')
  ...
  const fetchData = async () => {
    try {
      const [eventsResponse, resumesResponse] = await Promise.all([
